LANG = {
    "ru": {
        ...
        "media_tab": "Медиа (GIF/MP4/MP3/WAV/FLAC/Video)",
        ...
        "ecc_label": "Коррекция ошибок (ECC) для JPEG",
        ...
        "saved_as": "Сохранено: {}",
        "empty_result": "Нет данных для сохранения",
        ...
        "rs_btn": "Анализ RS (Regular/Singular)",
        "rs_working": "Анализ RS...",
        "rs_result": "Результаты RS-стеганоанализа\n\n",
        "rs_channel": "  Канал {0}: Regular={1:.4f}, Singular={2:.4f}\n",
        "rs_diff": "    Разница: {0:.4f}\n",
        "rs_suspicious": "    ПОДОЗРИТЕЛЬНО: R ≈ S (возможна стеганография)\n",
        "rs_clean": "    Естественное распределение\n",
        "rs_verdict": "RS-анализ: {0}\n",
        "rs_detected": "Стеганография обнаружена!",
        "rs_clean_verdict": "Стеганография не обнаружена",
        "ecc_level_label": "Уровень ECC:",
        "ecc_level_0": "Выкл",
        "ecc_level_1": "5%",
        "ecc_level_2": "10%",
        "ecc_level_3": "25%",
        "key_label": "Ключ (hex):",
        "key_hint": "(альтернатива паролю)",
        "psychovisual_chk": "Психовизиальная модель K-LSB (HSV)",
        "streaming_mode": "Потоковый режим",
        "streaming_hint": "(обработка без загрузки всего файла в память)",
        "img_compare_tab": "Сравнение изображений",
        "img_compare_orig": "Оригинал",
        "img_compare_encoded": "С результатом",
        "img_compare_diff": "Разница",
        "img_compare_hint": "Выберите оригинал и закодированное изображение для сравнения",
        "img_compare_select_orig": "Выбрать оригинал",
        "img_compare_select_encoded": "Выбрать результат",
        "img_compare_btn": "Сравнить",
        "diff_preview": "Визуализация разницы",
        "media_add_codec": "Дополнительные форматы (требуют pydub)",
        "scan_method": "  Метод: {}\n",
        "scan_data_size": "  Размер данных: {}\n",
        "learn_tab": "Обучение",
        "learn_title": "Интерактивная песочница (пошаговая визуализация)",
        "learn_select": "Выбрать изображение",
        "learn_embed_text": "Текст для внедрения:",
        "learn_visualize": "Визуализировать",
        "learn_step1": "1. Исходное изображение",
        "learn_step2": "2. После внедрения (LSB-1)",
        "learn_step3": "3. Разница (увелич. x10)",
        "learn_step4": "4. LSB-слой (x10 контраст)",
        "learn_info": "Информация",
        "learn_pixel_changed": "Изменено пикселей: {} из {} ({:.1f}%)",
        "learn_bits_embedded": "Внедрено бит: {}",
        "learn_psnr": "PSNR: {:.2f} dB",
        "learn_lsb_explain": "LSB (Least Significant Bit) — замена младшего бита каждого\nканала пикселя. Изменение незаметно для глаза,\nно детектируется статистическим анализом.",
        "learn_how_it_works": "Как это работает:\n• Каждый пиксель имеет R,G,B (по 8 бит)\n• LSB-стеганография заменяет последний бит\n• Человеческий глаз не замечает разницы\n• 1 бит на канал = 3 бита на пиксель\n• Для изображения 100x100 можно спрятать ~3.75 KB",
        "learn_dct_tab": "JPEG DCT",
        "learn_dct_explain": "DCT-стеганография работает в частотной области:\n• Изображение делится на блоки 8x8\n• К каждому блоку применяется DCT\n• Данные прячутся в AC-коэффициентах\n• Устойчиво к JPEG-сжатию\n• Методы: JSteg (LSB в DCT) и F5 (матричное внедрение)",
        "jpeg_dct_tab": "JPEG DCT",
        "jpeg_dct_label": "JPEG DCT стеганография (устойчивость к сжатию)",
        "jpeg_dct_hint": "Внедрение в DCT-коэффициенты JPEG (JSteg/F5)",
        "jpeg_dct_btn": "Кодировать в JPEG (DCT)",
        "jpeg_dct_f5_chk": "Использовать F5-внедрение",
        "attack_tab": "Атака",
        "attack_btn": "Авто-атака",
        "attack_working": "Выполнение авто-атаки...",
        "attack_found": "Найдено {} решений:",
        "attack_none": "Данные не найдены",
        "cloud_tab": "Облако",
        "cloud_provider": "Провайдер:",
        "cloud_upload_btn": "Загрузить в облако",
        "cloud_download_btn": "Скачать из облака",
        "cloud_bucket": "S3 Bucket / FTP Host:",
        "cloud_user": "Пользователь:",
        "cloud_password": "Пароль:",
        "cloud_region": "AWS Region:",
        "cloud_working": "Работа с облаком...",
        "cloud_success": "Успешно: {}",
        "cloud_error": "Ошибка: {}",
        "cloud_no_providers": "Нет доступных облачных провайдеров\nУстановите: pip install boto3 google-auth google-api-python-client",
    },
    "en": {
        ...
        "media_tab": "Media (GIF/MP4/MP3/WAV/FLAC/Video)",
        ...
        "ecc_label": "Error correction (ECC) for JPEG",
        ...
        "rs_btn": "RS Analysis (Regular/Singular)",
        "rs_working": "Analyzing RS...",
        "rs_result": "RS Steganalysis Results\n\n",
        "rs_channel": "  Channel {0}: Regular={1:.4f}, Singular={2:.4f}\n",
        "rs_diff": "    Diff: {0:.4f}\n",
        "rs_suspicious": "    SUSPICIOUS: R ≈ S (possible steganography)\n",
        "rs_clean": "    Natural distribution\n",
        "rs_verdict": "RS Analysis: {0}\n",
        "rs_detected": "Steganography detected!",
        "rs_clean_verdict": "No steganography detected",
        "ecc_level_label": "ECC Level:",
        "ecc_level_0": "Off",
        "ecc_level_1": "5%",
        "ecc_level_2": "10%",
        "ecc_level_3": "25%",
        "key_label": "Key (hex):",
        "key_hint": "(alternative to password)",
        "psychovisual_chk": "Psychovisual K-LSB model (HSV)",
        "streaming_mode": "Streaming mode",
        "streaming_hint": "(process without loading entire file into memory)",
        "img_compare_tab": "Image Comparison",
        "img_compare_orig": "Original",
        "img_compare_encoded": "With result",
        "img_compare_diff": "Difference",
        "img_compare_hint": "Select original and encoded image for comparison",
        "img_compare_select_orig": "Select original",
        "img_compare_select_encoded": "Select result",
        "img_compare_btn": "Compare",
        "diff_preview": "Difference Preview",
        "media_add_codec": "Additional formats (require pydub)",
        "scan_method": "  Method: {}\n",
        "scan_data_size": "  Data size: {}\n",
        "learn_tab": "Learning",
        "learn_title": "Interactive Sandbox (step-by-step visualization)",
        "learn_select": "Select image",
        "learn_embed_text": "Text to embed:",
        "learn_visualize": "Visualize",
        "learn_step1": "1. Original image",
        "learn_step2": "2. After embedding (LSB-1)",
        "learn_step3": "3. Difference (x10 magnified)",
        "learn_step4": "4. LSB layer (x10 contrast)",
        "learn_info": "Info",
        "learn_pixel_changed": "Pixels changed: {} of {} ({:.1f}%)",
        "learn_bits_embedded": "Bits embedded: {}",
        "learn_psnr": "PSNR: {:.2f} dB",
        "learn_lsb_explain": "LSB (Least Significant Bit) — replaces the least significant bit\nof each pixel channel. The change is invisible to the eye\nbut detectable by statistical analysis.",
        "learn_how_it_works": "How it works:\n• Each pixel has R,G,B (8 bits each)\n• LSB steganography replaces the last bit\n• The human eye cannot notice the change\n• 1 bit per channel = 3 bits per pixel\n• For a 100x100 image, you can hide ~3.75 KB",
        "learn_dct_tab": "JPEG DCT",
        "learn_dct_explain": "DCT steganography works in the frequency domain:\n• Image is split into 8x8 blocks\n• DCT is applied to each block\n• Data is hidden in AC coefficients\n• Resistant to JPEG compression\n• Methods: JSteg (LSB in DCT) and F5 (matrix embedding)",
        "jpeg_dct_tab": "JPEG DCT",
        "jpeg_dct_label": "JPEG DCT steganography (compression resistant)",
        "jpeg_dct_hint": "Embedding in JPEG DCT coefficients (JSteg/F5)",
        "jpeg_dct_btn": "Encode to JPEG (DCT)",
        "jpeg_dct_f5_chk": "Use F5 embedding",
        "attack_tab": "Attack",
        "attack_btn": "Auto Attack",
        "attack_working": "Running auto attack...",
        "attack_found": "Found {} solutions:",
        "attack_none": "No data found",
        "cloud_tab": "Cloud",
        "cloud_provider": "Provider:",
        "cloud_upload_btn": "Upload to cloud",
        "cloud_download_btn": "Download from cloud",
        "cloud_bucket": "S3 Bucket / FTP Host:",
        "cloud_user": "User:",
        "cloud_password": "Password:",
        "cloud_region": "AWS Region:",
        "cloud_working": "Cloud operation...",
        "cloud_success": "Success: {}",
        "cloud_error": "Error: {}",
        "cloud_no_providers": "No cloud providers available\nInstall: pip install boto3 google-auth google-api-python-client",
    }
}
